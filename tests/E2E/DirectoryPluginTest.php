...
function dirExpectedBootstrap ( string $file ): string
{
	...
	return dirNormalizeBootstrap( $content );
}
...
describe( 'AutoloadPlugin::runtime e2e', function () {
	...
	it( 'adds header and footer to generated bootstrap', function () {
		...
		$importPos = strpos( $result['content'], 'require_once' );
		...
		expect( $guardPos )->toBeLessThan( $importPos );
		expect( $footerPos )->toBeGreaterThan( $importPos );
	} );
